...
func (m *DelegationLock) GetStart() uint64 {
	if m != nil {
		return m.Start
	}
	return 0
...
func (m *DelegationLock) GetLength() uint64 {
	if m != nil {
		return m.Length
	}
	return 0
...
var fileDescriptor_9f2cf4649090b72c = []byte{
	...
	0x18, 0x35, 0x58, 0x82, 0x20, 0x1c, 0x21, 0x31, 0x2e, 0xb6, 0x9c, 0xd4, 0xbc, 0xf4, 0x92, 0x0c,
	...
	0x00, 0x00, 0xff, 0xff, 0x05, 0x74, 0xcb, 0x82, 0x0c, 0x01, 0x00, 0x00,
}
